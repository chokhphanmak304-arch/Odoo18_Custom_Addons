...
class VehicleBooking(models.Model):
    ...
    # เพิ่มเติม
    planned_start_date = fields.Datetime('วันเวลาที่วางแผนออกเดินทาง')
        ...
        for record in self:
            ...
            if record.vehicle_id:
                ...
                if original_planned_end_date_t:
                    ...
                    _logger.info(f"✅ Updated next_assignation_date to {original_planned_end_date_t} for vehicle {record.vehicle_id.license_plate}")
